...
public class AfficherProfesseur extends JFrame implements ActionListener
{
	...
	public void tabAffichage()
	{
	    ...
	    JComboBox Matiere = new JComboBox(tabMatiere);
	    ...
	    Object[][] data = 
	    {
		      {"nyto","Delgorge", "Tony", "cours.tony@gmail.com","16/12/1991",tabMatiere[0],tabClasse[0]},
		      {"adamette","Menebhi", "Adam", "menebhi.adam@gmail.com","30/07/1989",tabMatiere[0],tabClasse[0]},
		      {"popocheat","Popowicz", "Mikael", "popowicz.mikael@gmail.com","16/12/1989",tabMatiere[0],tabClasse[0]},
		      {"soubrannette","Soubranne", "Paul", "soubranne.paul@gmail.com","10/11/1992",tabMatiere[0],tabClasse[0]},
	    };
	    
	  
		String  title[] = {"Surnom","Nom", "Prénom", "Email","Date de naissance","Matiere","Classe"};  //LES TITRES DES COLONNES
	   ...
	   this.tableau.getColumn("Matiere").setCellEditor(new  DefaultCellEditor(Matiere));
	...
	{
		//AfficherProfesseur affP = new AfficherProfesseur();
	}
